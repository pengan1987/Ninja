...
public class NinjaWebViewImpl extends WebView implements NinjaWebView {
    ...
    public NinjaWebViewImpl(Context context) {
    ...
    public synchronized void update(int progress) {
        ...
        if (isLoadFinish()) {
            ...
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    setAlbumCover(ViewUnit.capture(NinjaWebViewImpl.this, dimen144dp, dimen108dp, false, Bitmap.Config.RGB_565));
                }
            }, animTime);
